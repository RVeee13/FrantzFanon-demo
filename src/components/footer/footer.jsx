    ...
    <div className='footer-container'>
        ...
        <Reveal2>
          <div className="footer-item">
              ...
              <div className='footer-icon-container'><a href="mailto:ehsfrantzfanon@yahoo.fr" target='_blank' rel="noopener noreferrer"><Mail width={24} height={24} color='#fff'/><span className='footer-icon-text'>ehsfrantzfanon@yahoo.fr</span></a> </div>
              <div className='footer-icon-container'><a href="https://www.google.com/maps/dir//''/@36.4835656,2.7554726,13z/data=!4m9!4m8!1m0!1m5!1m1!1s0x128f0ca26ac33231:0xf1641e29ac04e262!2m2!1d2.7967579!2d36.4835037!3e0?entry=ttu" target='_blank' rel="noopener noreferrer"><MapPin width={24} height={24} color='#fff'/><span className='footer-icon-text'>Zabana, Blida</span></a></div>
          </div>
        </Reveal2>
    </div>
  )
